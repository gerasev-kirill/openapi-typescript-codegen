...
export const registerHandlebarTemplates = (root: {
    ...
    const hbsFilesOverride: { [key: string]: TemplateSpecification } = {};
    ...
    const templates: Templates = {
        ...
        exports: {
            model: Handlebars.template(hbsFilesOverride.exportModel || templateExportModel),
            schema: Handlebars.template(hbsFilesOverride.exportSchema || templateExportSchema),
            service: Handlebars.template(hbsFilesOverride.exportService || templateExportService),
        },
        core: {
